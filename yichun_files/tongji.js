...
{
	var unit_id     = "2989448";
	var client_ip   = "112.90.32.1";
	var server_time = "1420505478";
	var verify_code = "edac993e";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2989448/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
